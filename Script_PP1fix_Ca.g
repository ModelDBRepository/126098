...
str OutputcAMPfilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000cAMP.txt"}
str OutputCdk5filename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000Cdk5.txt"}
str OutputCK1filename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000CK1.txt"}
str OutputDfilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000D.txt"}
str OutputD34filename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000D34.txt"}
str OutputD75filename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000D75.txt"}
str OutputD137filename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000D137.txt"}
str OutputInhD34filename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000InhD34.txt"}
str OutputInhD75filename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000InhD75.txt"}
str OutputPP1filename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000PP1.txt"}
str OutputCaMKIIfilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000CaMKII.txt"}
str OutputCaMfilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000CaM.txt"}
str OutputPP2Bfilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000PP2B.txt"}
str OutputPKAfilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000PKA.txt"}
str OutputPP2ACafilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000PP2ACa.txt"}
str OutputPP2APKAfilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000PP2APKA.txt"}
str OutputPKAefilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000PKAe.txt"}
str OutputPP2ACaefilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000PP2ACae.txt"}
str OutputPP2APKAefilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000PP2APKAe.txt"}
str OutputMRfilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000MR.txt"}

str OutputtotalcAMPfilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000totalcAMP.txt"}
str OutputCaMfilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000CaM.txt"}
str OutputCaM_TR2_Ca2filename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000CaM_TR2_Ca2.txt"}
str OutputCaM_Ca3filename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000CaM_Ca3.txt"}
str OutputCaM_Ca4filename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000CaM_Ca4.txt"}
str OutputACfilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000AC.txt"}
str OutputAC_Cafilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000AC_Ca.txt"}
str OutputAC_Gsafilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000AC_Gsa.txt"}
str OutputACGsa_Cafilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000ACGsa_Ca.txt"}
str OutputAC_Gsa_ATPfilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000AC_Gsa_ATP.txt"}
str OutputACGsa_Ca_ATPfilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000ACGsa_Ca_ATP.txt"}
str OutputI1filename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000I1.txt"}
str OutputI1_pfilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000I1p.txt"}
str OutputPP1_I1filename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000I1_PP1.txt"}
str OutputPP1_I1_pfilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000I1p_PP1.txt"}
str OutputPDE1filename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000PDE1.txt"}
str OutputPDE2filename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000PDE2.txt"}
str OutputPDE_CaMfilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000PDE_CaM.txt"}
str OutputPDE_pfilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000PDE_p.txt"}
str OutputGluRfilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000GluR.txt"}
str OutputGluR831filename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000GluR831.txt"}
str OutputGluR845filename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000GluR845.txt"}
str OutputGluRIfilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000GluRI.txt"}
str OutputGluR831Ifilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000GluR831I.txt"}
str OutputGluR845Ifilename = {"./" @ {save_directory} @ "/PP1fix_" @ {Input_Ca} @ "_000GluR845I.txt"}
