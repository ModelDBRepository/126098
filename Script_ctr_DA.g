...
str OutputcAMPfilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "cAMP.txt"}
str OutputCdk5filename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "Cdk5.txt"}
str OutputCK1filename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "CK1.txt"}
str OutputDfilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "D.txt"}
str OutputD34filename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "D34.txt"}
str OutputD75filename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "D75.txt"}
str OutputD137filename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "D137.txt"}
str OutputInhD34filename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "InhD34.txt"}
str OutputInhD75filename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "InhD75.txt"}
str OutputPP1filename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "PP1.txt"}
str OutputCaMKIIfilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "CaMKII.txt"}
str OutputCaMfilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "CaM.txt"}
str OutputPP2Bfilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "PP2B.txt"}
str OutputPKAfilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "PKA.txt"}
str OutputPP2ACafilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "PP2ACa.txt"}
str OutputPP2APKAfilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "PP2APKA.txt"}
str OutputPKAefilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "PKAe.txt"}
str OutputPP2ACaefilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "PP2ACae.txt"}
str OutputPP2APKAefilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "PP2APKAe.txt"}
str OutputMRfilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "MR.txt"}

str OutputtotalcAMPfilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "totalcAMP.txt"}
str OutputCaMfilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "CaM.txt"}
str OutputCaM_TR2_Ca2filename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "CaM_TR2_Ca2.txt"}
str OutputCaM_Ca3filename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "CaM_Ca3.txt"}
str OutputCaM_Ca4filename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "CaM_Ca4.txt"}
str OutputACfilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "AC.txt"}
str OutputAC_Cafilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "AC_Ca.txt"}
str OutputAC_Gsafilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "AC_Gsa.txt"}
str OutputACGsa_Cafilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "ACGsa_Ca.txt"}
str OutputAC_Gsa_ATPfilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "AC_Gsa_ATP.txt"}
str OutputACGsa_Ca_ATPfilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "ACGsa_Ca_ATP.txt"}
str OutputI1filename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "I1.txt"}
str OutputI1_pfilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "I1p.txt"}
str OutputPP1_I1filename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "I1_PP1.txt"}
str OutputPP1_I1_pfilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "I1p_PP1.txt"}
str OutputPDE1filename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "PDE1.txt"}
str OutputPDE2filename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "PDE2.txt"}
str OutputPDE_CaMfilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "PDE_CaM.txt"}
str OutputPDE_pfilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "PDE_p.txt"}
str OutputGluRfilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "GluR.txt"}
str OutputGluR831filename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "GluR831.txt"}
str OutputGluR845filename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "GluR845.txt"}
str OutputGluRIfilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "GluRI.txt"}
str OutputGluR831Ifilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "GluR831I.txt"}
str OutputGluR845Ifilename = {"./" @ {save_directory} @ "/000_" @ {Input_DA} @ "GluR845I.txt"}
